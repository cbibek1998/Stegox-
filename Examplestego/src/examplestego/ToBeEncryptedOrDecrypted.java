...
public class ToBeEncryptedOrDecrypted extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        heading.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        heading.setText("List of files/folders to be encrypted:");
        ...
        reSelectFilesButton.setFont(new java.awt.Font("Bell MT", 1, 12)); // NOI18N
        ...
        addMoreFilesButton.setFont(new java.awt.Font("Bell MT", 1, 12)); // NOI18N
    ...
    private void addMoreFilesButtonActionPerformed(java.awt.event.ActionEvent evt)                                                   
    {                                                       
    ...
    private void encryptOrDecryptButtonActionPerformed(java.awt.event.ActionEvent evt)                                                       
    {                                                           
        setVisible(false);
        dispose();
        if(encryptOrDecrypt.equalsIgnoreCase("encrypt"))
    ...
    private void reSelectFilesButtonActionPerformed(java.awt.event.ActionEvent evt)                                                    
    {                                                        
